...
im = PhotoImage(file='photos/bb.png')
index.iconphoto(False, im)
...
######PAGEEEEE1
f1 = Frame(page1, bg="white", width="880", height="500")
f1.place(x=0, y=0)

##########photoooooo
photo = PhotoImage(file="photos/m.png")
y=Label(page1,image=photo)
y.place(x=0,y=0,width=800,height=500)
############


l1 = Label(page1, text="SMOOTHIE PARADISE", fg="yellow", bg="#afce9b", font=(("cairo", 20, "italic")))
l1.place(x=265, y=0)
# f2=Frame(page1,bg="white",width=250,height=500)
# f2.place(x=1,y=40)

l3 = Label(page1, text='Follow Us For More Updates!', fg="black", bg="yellow", font=("Times New Roman", 15, "italic"))
l3.place(x=0, y=395)
l4 = Label(page1, text='For Location', fg="black", bg="yellow", font=("Times New Roman", 15, "italic"))
l4.place(x=686, y=395)
...
logoo1 = PhotoImage(file="photos/x11111.png")
y2 = Label(page1, image=logoo1, bg="#4267B2")

# logo insta
logoo2 = PhotoImage(file="photos/sociall.png")
y3 = Label(page1, image=logoo2, bg="#E4405F")

# logo tiktok
logoo3 = PhotoImage(file="photos/social.png")
y4 = Label(page1, image=logoo3, bg="#000000")
##logoo location
logoo4=PhotoImage(file="photos/locc.png")
y5 = Label(page1, image=logoo4, bg="#000000")

##logooocart
logoo5=PhotoImage(file="photos/cartt.png")
y6 = Label(page1, image=logoo5, bg="white")
###logoooooo menu
logoo6=PhotoImage(file="photos/menuu.png")
y7 = Label(page1, image=logoo6, bg="#000000")



b1 = Button(page1, text="Facebook", fg="white", bg="#4267B2", width=28, height=30,image=logoo1, font="Helvetica,16,bold", command=facee)
b1.place(x=40,y=440)
b2 = Button(page1, text="Instagram", fg="white", bg="#E4405F",image=logoo2, width=28, height=30, font="Helvetica,16,bold", command=instaa)
b2.place(x=90, y=440)
b3 = Button(page1, text="Tiktok", fg="white", bg="#000000", width=28,image=logoo3, height=30, font="Helvetica,16,bold", command=tiktokk)
b3.place(x=150, y=440)
b4 = Button(page1, bg="red", width=28,image=logoo4, height=30, font="Helvetica,16,bold", command=locationn)
b4.place(x=730, y=440)
...
l5.place(x=642, y=80)
btn_to_menu = Button(page1, text="Go to menu",width=0,height= 0, bg="white", font=("Helvetica", 14),image=logoo6, command=lambda: show_frame(page2))
btn_to_menu.place(x=45, y=60)
...
def order():
    ...
    if name and address and phone:
        message_label.config(text="Order Successful! Your order will arrive in approx 45 minutes.", fg="green")
    else:
...
Button(page4, text="Return to Home", width=15, bg="blue",command=lambda: show_frame(page1)).place(x=10, y=470)
